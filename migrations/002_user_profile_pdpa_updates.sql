-- Migration: Add user profile fields and PDPA compliance
...
-- 5. Insert initial terms and PDPA versions
INSERT INTO terms_versions (version, type, content, active) VALUES
('1.0', 'terms', '1. ผู้เข้าร่วมต้องเป็นผู้ติดตาม (Subscribe) ช่อง Annanped บน YouTube
...
('1.0', 'pdpa', '1. เราจะเก็บรักษาข้อมูลส่วนบุคคลของท่านอย่างปลอดภัย
...
-- 12. Add constraints for data validation
ALTER TABLE users 
...
-- Add constraint for name lengths
ALTER TABLE users 
